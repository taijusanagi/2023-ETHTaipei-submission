...
contract VerifiedAnonymous {
    ...
    function createEvent(uint256 groupId, string memory metadata) external {
        ...
        require(groupId > 0, "VerifiedAnonymous: group id is invalid");
    ...
    function verifyAndJoinEvent(uint256 identityCommitment, uint256 tokenId) external {
        require(xpoap.ownerOf(tokenId) == msg.sender, "VerifiedAnonymous: msg sender is invalid");
